...
| `routes` | The first route whose `match` fits the output is used; no match means your saver does not apply. `args` are passed to your program. `name` becomes part of the cache key. |
